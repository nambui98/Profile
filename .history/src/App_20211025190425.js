            ...
            <div className="flex h-screen w-screen items-center justify-center">
                <div className="flex w-full items-start justify-center" style={{ height: "600px" }}>
                    <div className="relative rounded-3xl md:w-6/12 sm:w-10/12 p-6 h-full mx-4 bg-app shadow flex justify-center items-center flex-col">
                        ...
                        <div className="absolute bottom-10 md:right-10 md:left-10 right-20 left-20 flex items-center justify-between">
                            ...
                            <span className="flex flex-row-reverse items-center"><button className="btn-shadow rounded-full text-center w-12 h-12"><FaPrint className="text-xl" fill={"#e74c3c"} /></button><span className="ml-3">Print my resume</span></span>
                        </div>
                    </div>
