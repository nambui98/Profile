        ...
        <div className="App">
            <div className="flex h-screen w-screen items-center justify-center">
                ...
                <div className="rounded-3xl w-4/12 h-auto m-4 bg-app shadow flex items-center flex-col py-10 px-6">
                    ...
                    <h1 className="text-gray-400 dark:text-white font-extrabold tracking-max text-xl mb-5">FRONT END DEV</h1>
                    <ul>
                        <li className="btn-shadow w-40 h-10 rounded-2xl">Home</li>
                        <li>Home</li>
                        <li>Home</li>
                        <li>Home</li>
                        <li>Home</li>
