        ...
        <div className="App">
            <div className="flex h-screen w-screen items-center justify-center">
                ...
                <div className="rounded-3xl w-4/12 h-auto m-4 bg-app shadow flex items-center flex-col py-10 px-6">
                    ...
                    <ul>
                        <li className="text-black dark:text-white btn-shadow w-40 h-10 rounded-2xl mt-5">Home</li>
                        <li className="text-black dark:text-white btn-shadow w-40 h-10 rounded-2xl mt-5">About</li>
                        <li className="text-black dark:text-white btn-shadow w-40 h-10 rounded-2xl mt-5">Portfolio</li>
                        <li className="text-black dark:text-white btn-shadow w-40 h-10 rounded-2xl mt-5">Blog</li>
                        <li className="text-black dark:text-white btn-shadow w-40 h-10 rounded-2xl mt-5">Contact</li>
                    </ul>
                </div>
            </div>
        </div >
