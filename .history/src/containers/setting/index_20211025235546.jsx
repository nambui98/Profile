...
export default function Setting() {
    ...
    return (
        <div className={`relative flex transform py-7 duration-500 shadow ${active?"translate-x-0":"translate-x-32"}`} style={{boxShadow: "3px 3px 8px #b1b1b1,-3px -3px 8px #fff"}} >
            <button className="absolute -left-8 -top-10 btn-shadow rounded-full text-center w-10 h-10" onClick={()=>setActive(!active)}>
