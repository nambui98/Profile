...
export default function Setting() {
    ...
    return (
        <div className={`relative rounded-3xl flex justify-between transform py-7 duration-500 shadow ${active?"translate-x-0":"translate-x-full"}`} >
            ...
            {/* <div className={`absolute `}> */}
                ...
                <button className="btn-setting rounded-full text-center w-12 h-12" onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}>
                {theme === 'dark' ? (
                    <FaSun
                ...
                <button className="btn-setting rounded-full text-center w-12 h-12">
                    <FaRegSun class="animate-spin duration-1000 text-3xl" style={{ animationDuration: "2s" }} fill={colors.coolGray[400]} />
                </button>
            {/* </div> */}
        </div>
