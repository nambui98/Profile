...
export default function Setting() {
    ...
    return (
        <div>
            <button className="btn-shadow rounded-full text-center w-10 h-10" onClick={()=>setActive(true)}>
                <FaRegSun class="animate-spin duration-1000 text-3xl" style={{ animationDuration: "2s" }} fill={colors.coolGray[400]} />
            </button>
            <div className={`transform duration-500 ${active?"translate-x-0":"translate-x-96 "}`}>
