...
export default function Setting() {
    ...
    return (
        <div className={`relative transform  btn-shadow-darklight duration-500 ${active?"translate-x-0":"translate-x-12"}`}>
            <button className="absolute -left-1/3 -top-5 btn-shadow rounded-full text-center w-10 h-10" onClick={()=>setActive(!active)}>
