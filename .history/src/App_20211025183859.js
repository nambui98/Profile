        ...
        <div className="App">
            <div className="flex h-screen w-screen items-center justify-center">
                <div className="flex w-full items-start justify-center" style={{ height: "600px" }}>
                    <div className="relative rounded-3xl w-6/12 p-6 h-full mx-4 bg-app shadow flex justify-center items-center flex-col">
                    ...
                    <div className="rounded-3xl w-4/12 h-full mx-4 bg-app shadow flex items-center flex-col py-10 px-6">
                        ...
                        <ul>
                            <li className="text-gray-600 dark:text-white font-bold btn-shadow w-50 h-10 rounded-2xl mt-5">Home</li>
